  ...
  es: {
    ...
    work: {
      ...
      descriptions: {
        ...
        "08":
          "API serverless construida con Node.js y Express que envía notificaciones en Telegram cada vez que alguien visita el portafolio. Incluye CORS por dominio, anti-spam por IP, despliegue en Vercel y integración con el front-end mediante un endpoint REST.",
      },
    },
    contact: {
      title: "Conversemos",
