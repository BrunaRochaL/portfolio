  ...
  pt: {
    ...
    work: {
      ...
      descriptions: {
        ...
        "08":
          "API serverless em Node.js e Express que envia notificações no Telegram sempre que alguém acessa o portfólio. Inclui controle de CORS por domínio, anti-spam por IP, deploy na Vercel e integração com o front-end via endpoint REST.",
      },
    },
    contact: {
  ...
  en: {
    ...
    work: {
      ...
      descriptions: {
        ...
        "08":
          "Serverless API built with Node.js and Express that sends Telegram notifications whenever someone visits the portfolio. Features domain-based CORS, IP deduplication, Vercel deployment, and front-end integration through a REST endpoint.",
      },
    },
    contact: {
      title: "Let's connect",
  ...
  es: {
    ...
    work: {
      ...
      descriptions: {
        ...
        "08":
          "API serverless construida con Node.js y Express que envía notificaciones en Telegram cada vez que alguien visita el portafolio. Incluye CORS por dominio, anti-spam por IP, despliegue en Vercel e integración con el front-end mediante un endpoint REST.",
      },
    },
    contact: {
      title: "Conversemos",
